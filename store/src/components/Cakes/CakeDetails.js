        ...
        cake && (
          <div className={styles.cakeDetailed}>
            ...
            <div>
              ...
              <button className={styles.addToCart} onClick={(e) => onAddClick(cake, e.target.innerText)}>Добавить в Корзину</button>
              <button className={styles.buyNow} onClick={(e) => onAddClick(cake, e.target.innerText)}>Купить сейчас</button>
              <h3>Подробнее:</h3>
              <ul>
